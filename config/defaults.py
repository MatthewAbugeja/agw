...
_C.DATASETS.NAMES = ('dukemtmc, market1501')
# Root directory where datasets-images should be used (and downloaded if not found)
_C.DATASETS.ROOT_DIR = ('datasets-images')
